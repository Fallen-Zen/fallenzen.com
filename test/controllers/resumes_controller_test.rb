...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { company: @resume.company, description: @resume.description, from: @resume.from, name: @resume.name, to: @resume.to }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { company: @resume.company, description: @resume.description, from: @resume.from, name: @resume.name, to: @resume.to }
    assert_redirected_to resume_path(assigns(:resume))
  end
